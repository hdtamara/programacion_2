"""
Ejercicio: Generador de Tarjetas de Jugador (estilo FIFA / Liga BetPlay)
-------------------------------------------------------------------------
Completa las 4 funciones marcadas con TODO. La interfaz gráfica ya está
lista y funcionando: solo le falta la "lógica" que tú vas a construir.
"""
